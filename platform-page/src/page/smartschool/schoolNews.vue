<template>
    <el-container>
        <el-container>
            ...
            <el-main>
                <data-grid ref="datagrid" url="/news/list" auth v-bind="$attrs" :postParams="postParams"
                ...
                @removeActionClick="({row})=>remove({rows:[row]})" @publishActionClick="publish" @revertActionClick="revert">
                    ...
                    <el-table-column label="来源" prop="source" show-overflow-tooltip></el-table-column>
                    <el-table-column label="排序" prop="sort" show-overflow-tooltip></el-table-column>
                    <el-table-column label="置顶" prop="top" show-overflow-tooltip :formatter="topFmt"></el-table-column>
                    ...
                    <el-tab-pane label="信息" name="info">
                        <div class="tabcontainer" style="height:350px;overflow:auto">
                            <el-form :model="formData" ref="form" label-width="80px" size="small" style="padding:10px 20px" label-suffix=":" :rules="rules">
                                ...
                                <el-row>
                                    <el-col :span="24">
                                        <el-form-item label="来源" prop="source">
                                            <el-input v-model="formData.source" placeholder="请输入文章来源"></el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                <el-row>
                                ...
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="排序号" prop="sort">
                                            <el-input-number v-model="formData.sort" :min="0" :max="100000"></el-input-number>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="12">
                                ...
                                <el-row>
                                    <el-col :span="12" prop="cover">
                                        <el-form-item label="缩略图" prop="cover">
                                            <el-upload :multiple="false" accept="image/*" :limit="1" :http-request="uploadCover" list-type="picture"
...
import * as schoolNewsApi from '../../api/smartschool/schoolNews'
export default {
  inheritAttrs: false,
  components: {
    OrgTree,
  ...
  methods: {
    ...
    _saveNews () {
      ...
      schoolNewsApi[this.dialogIsEdit ? 'save' : 'save'](this.formData)
        .then(node => {
          this.closeDialog()
          this.$refs.datagrid.reload()
        })
